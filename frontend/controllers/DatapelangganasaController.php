...
class DatapelangganasaController extends Controller
{
    ...
    /**
     * Lists all datapelangganasa models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new datapelangganasaSearch();
    ...
    /**
     * Displays a single datapelangganasa model.
     * @param int $no No
     * @return string
    ...
    /**
     * Creates a new datapelangganasa model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new datapelangganasa();
    ...
    /**
     * Updates an existing datapelangganasa model.
    ...
    /**
     * Deletes an existing datapelangganasa model.
    ...
    /**
     * Finds the datapelangganasa model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $no No
     * @return datapelangganasa the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($no)
    {
        if (($model = datapelangganasa::findOne(['no' => $no])) !== null) {
            return $model;
        }
